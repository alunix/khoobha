        ...
        try {
            for (i = 0; i < events.length(); i++) {
                ...
                if (table.equals("child")) {
                    ...
                    values = object.getString("id") +",'"+ object.getString("title") +"',"+ object.getString("points") +","+ object.optString("category", "1") +","+ object.optString("solitary", "0");
        ...
        while (!cursor.isAfterLast()) {
            ...
            if (cursor2.getCount() > 0) {
                ...
                if (table.equals(DatabaseHelper.TABLE_CHILD)) {
                    ...
                    args.add(new BasicNameValuePair("category", cursor2.getString(3)));
